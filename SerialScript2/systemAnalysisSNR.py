...
# plt.ylim([0,0.35])
for i in range(3):
    plt.plot(range(datanum), snr[i+2]-150-15, marker = lineshape[i], linestyle='dashed', color = 'black', label = i+3)
...
plt.ylabel("SNR", font1)
plt.xlabel("Upload Cycle", font1)
# plt.ylim(-170,-120)
plt.savefig(savepath + '\\' + "systemAnalysisSNR" + ".svg", bbox_inches='tight', format = "svg")
plt.show()
